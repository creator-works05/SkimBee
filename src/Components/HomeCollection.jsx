    ...
    <div className="collection-hmclctn">
        {
            filterProduct.map((el,i)=>{
                ...
                if(j<=4){
                    if(j===1){
                        return <div className='big-hmclctn'></div>
                    }
                    if(j===2){
                        return <div className='small-hmclctn'></div>
                    ...
                    if(j===4){
                        ...
                        return <div className='flex-hmclctn' style={{gridColumn:"span 7"}}></div>
                    }
                }
                else if(j<=8){
                     if(j===5 || j===6){
                        return <div className='mid-hmclctn'></div>
                    }
                    if(j===7){
                        return <div style={{gridColumn:"span 7"}} className='flex-hmclctn'></div>
                    ...
                    if(j===15){
                        ...
                        return <div style={{gridColumn:"span 6"}} className='flex-hmclctn'></div>
                    }
                }
                else{
                     if(j===17||j===20){

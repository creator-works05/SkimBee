const _ = `http://localhost:3000/users
http://localhost:3000/userLogs
http://localhost:3000/mainType
http://localhost:3000/admin`

const urlusers=`http://localhost:3000/users`
const urluserLogs=`http://localhost:3000/userLogs`
const urlmainType=`http://localhost:3000/mainType`
